...
const PATHS: Record<IconName, { d: string; evenOdd?: boolean }> = {
  ...
  user: {
    d: 'M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0-8a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 10c-5.05 0-9 2.48-9 5.65V21a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-1.35C21 16.48 17.05 14 12 14Zm-7 6c.33-2.1 3.22-4 7-4s6.67 1.9 7 4H5Z',
  },
  logout: {
    d: 'M10 3H6a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h4a1 1 0 1 0 0-2H6a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4a1 1 0 1 0 0-2Zm5.3 4.3a1 1 0 0 1 1.4 0l3.99 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 0 1-1.4-1.4l2.3-2.3H10a1 1 0 1 1 0-2h7.59l-2.3-2.3a1 1 0 0 1 .01-1.4Z',
  },
  lock: {
